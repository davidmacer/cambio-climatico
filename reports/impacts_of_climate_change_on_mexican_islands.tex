...
\begin{figure}
  \begin{center}
  \includegraphics[scale=0.5]{../reports/figures/grafica_loglog_especies_por_area_todas_islas.png}
...
\begin{figure}
  \begin{center}
  \includegraphics[scale=0.5]{../reports/figures/porcentaje_area_perdida_incremento_nivel_mar_todas_islas.png}
...
\begin{figure}
  \begin{center}
  \includegraphics[scale=0.5]{../reports/figures/numero_especies_porcentaje_area_perdida_incremento_nivel_mar_islas_golfo_mar_caribe.png}
...
\begin{figure}
  \begin{center}
  \includegraphics[scale=0.5]{../reports/figures/especies_perdidas_incremento_nivel_mar_todas_islas.png}
